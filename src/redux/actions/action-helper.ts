...
export function makeActionCreators<Map extends ActionInfoMap>(map: Map) {
  return Object.fromEntries(Object.entries(map).map(entry => [entry[0], entry[1](entry[0])])) as {
...
export type MakeActionUnion<Creators extends { [key: string]: (arg: any) => any }> = ReturnType<
  Creators[keyof Creators]
>;
